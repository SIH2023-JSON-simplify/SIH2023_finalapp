        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView
                ...
                <View style={styles.boxCss}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate('Signupclient')} style={{ justifyContent: 'center', flexDirection: 'row', marginVertical: Utils.ScreenHeight(2) }}>
            ...
            {navigation.navigate("Verifyotpclient",{phno:number})}}><Text>testings</Text></TouchableOpacity>
        </SafeAreaView>
    )
}
